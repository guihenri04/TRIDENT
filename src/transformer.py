...
def initialize_weight(x):
    """
    Initializes the weight of a layer using Xavier uniform for weights and zeros for bias
    """
...
class FeedForwardNetwork(nn.Module):
    """
    Simple feed-forward network with two linear layers and ReLU activation
    """
